...
export default function SinglePost() {
    ...
    useEffect(() => {
        const getPost = async () => {
            const res = await axios.get("https://node-blog-backend-bonface.herokuapp.com/api/posts/" + path);
            setPost(res.data);
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`https://node-blog-backend-bonface.herokuapp.com/api/posts/${post._id}`, {
    ...
    const handleUpdate = async () => {
        try {
            await axios.put(`https://node-blog-backend-bonface.herokuapp.com/api/posts/${post._id}`, {
